...
(*
    ...
    Example 1: lostSheep [ 1; 2] [3; 4] 15 = Output: 5

    Example 2: lostSheep [ 3; 1; 2] [4; 5] 21 = Output: 6
...
[<Fact>]
let ``All sheep lost`` () =
    test <@ lostSheep [] [] 42 = 42 @>

[<Fact>]
let ``No sheep lost`` () =
    test <@ lostSheep [ 1 ] [ 41 ] 42 = 0 @>

[<Fact>]
let ``Multiple batches`` () =
    test <@ lostSheep [ 1; 11 ] [ 10; 10 ] 42 = 10 @>
